...
class StepAuth extends Component {
  ...
  apply = async () => {
    ...
    await axios.post(
      'https://finewf.club:9900/api/user/' + window.localStorage.getItem('user_id') + '/apply_media_editor/',
      {},
      config
    )
    const current = 1
  ...
  unapply = async () => {
    ...
    await axios.post(
      'https://finewf.club:9900/api/user/' + window.localStorage.getItem('user_id') + '/unapply_media_editor/',
      {},
      config
    )
    const current = 0
