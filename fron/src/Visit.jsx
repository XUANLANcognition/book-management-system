...
class Visit extends Component {
  ...
  isFollow = async (v) => {
    try {
      ...
      const response = await axios.post(
        'https://finewf.club:9900/api/user/' + this.props.match.params.id + '/is_followed/?format=json',
        {},
        config
      )
      this.setState({
  ...
  follow = async (v) => {
    try {
      ...
      axios.post(
        'https://finewf.club:9900/api/user/' + this.props.match.params.id + '/follow/?format=json',
        {},
        config
      )
      setTimeout(() => {
  ...
  unfollow = async (v) => {
    try {
      ...
      axios.post(
        'https://finewf.club:9900/api/user/' + this.props.match.params.id + '/unfollow/?format=json',
        {},
        config
      )
      setTimeout(() => {
  ...
  getProfileData = async (v) => {
    try {
      const response = await axios.get(
        'https://finewf.club:9900/api/user/' + this.props.match.params.id + '?format=json'
      )
